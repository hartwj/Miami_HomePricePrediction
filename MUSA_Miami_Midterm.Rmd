...
```{r histogram, message=FALSE, warning=FALSE, echo=FALSE, include=FALSE}
...
```{r prediction vs. observed, message=FALSE, warning=FALSE}
...
````{r abs err map, echo=FALSE, message=FALSE, warning=FALSE, include=FALSE}
ggplot() +
  annotation_map_tile("cartolight") +
  geom_sf(data=miami.base, fill='transparent') + 
